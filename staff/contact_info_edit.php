...
<?php
	...
	echo 'Email: &nbsp;&nbsp; <input type="text"  placeholder="' .htmlspecialchars($row2['email']) . '"><br><br>';
	echo 'Mobile No: &nbsp;&nbsp; <input type="text" placeholder="' .htmlspecialchars($row2['mobile']) . '"><br><br>';
	echo 'Fax No: &nbsp;&nbsp; <input type="text" placeholder="' .htmlspecialchars($row2['fax']) . '"><br><br>';
	echo 'Address Line 1: &nbsp;&nbsp; <input type="text" placeholder="' .htmlspecialchars($row2['addressline1']) . '"><br><br>';
	echo 'Address Line 2: &nbsp;&nbsp; <input type="text" placeholder="' .htmlspecialchars($row2['addressline2']) . '"><br><br>';
	echo "</fieldset>";
  	echo "</form>";

?>
<form action="contact_info_save.php" method="post" enctype="application/x-www-form-urlencoded" style="text-align:right;">
<input type="submit" name="save" value="Save" onClick="contact_info_save.php" class="button"/>
</form>
</form>
