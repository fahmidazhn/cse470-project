...
?>
<form action="edu_info_edit.php" method="post" enctype="application/x-www-form-urlencoded" style="text-align:right;">
<input type="submit" name="edit" value="Edit" onClick="edu_info_edit.php"/>
</form>
