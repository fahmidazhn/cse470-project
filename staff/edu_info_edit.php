...
<?php
	...
	elseif($row['userlevel'] ==3){
  	...
  	echo "<form>";
	echo "<fieldset>";
  	echo "<legend>Educational Information</legend>";
	...
	echo 'User Level: &nbsp;&nbsp; <input type="text" disabled placeholder="' .htmlspecialchars($userlevel) . '"><br><br>';
...
?>
<form action="edu_info_save.php" method="post" enctype="application/x-www-form-urlencoded" style="text-align:right;">
<input type="submit" name="save" value="Save" onClick="edu_info_save.php" class="button"/>
</form>
</form>
