...
<form action="add_teacher.php" method="post" enctype="application/x-www-form-urlencoded">
     <input type="submit" name="addBtn" value="Add New Teacher Info" onClick="add_teacher.php" class="button" /></dl>
</form>
<form action="view_teacher.php" method="post" enctype="application/x-www-form-urlencoded">    
 <input type="submit" name="viewBtn" value="View Current Teacher Info" onClick="view_teacher.php" class="button" />
